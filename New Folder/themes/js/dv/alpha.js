 ...
 *
 * $Id: alpha.js 10 2012-12-07 11:55:23Z admin $
 *
 * Dual licensed under the MIT and GPL licenses:
 *   http://www.opensource.org/licenses/mit-license.php
 *   http://www.gnu.org/licenses/gpl.html
...
$(document).ready(function(){
  ...
  // Load long loading scripts after the dom has loaded
  // if (dls.global.addThis) {
  //   $.getScript('https://s7.addthis.com/js/250/addthis_widget.js#username=livingsocial', function() {});
  // }

  //var t = setTimeout ( fontStats, 5000 );
});

function appendAsynchScript(src) {
  //console.debug("appendAsynchScript: " + src);
    (function() {
     var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;
     ga.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + src;
     (document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(ga);
    })();
}
function appendAsynchImg(src) {
    (function() {
...
;(function($) {
  ...
  dls.widgets.counter = function(element, options) {
    ...
    var self = this;
    this.timer = setInterval(function(){ self.tick(); }, interval);
  };

  dls.onSocialShare = function(url, counterId, externalId) {
    $.post(url, { external_id: externalId }, function(data){
      // counter will be incremented out of band
      // just increment on page on success
      var count = parseInt($('#'+counterId).html(), 0);
      $('#'+counterId).html(count + 1);
    });
  };
  ...
  dls.widgets.counter.prototype = {
    ...
    expired: function() {
      this.options[0][0] <= 0 && this.options[1][0] <= 0 && this.options[2][0] <= 0;
    },
...
dls.fbConnect = {
  init: function(appKey, options) {
    window.fbAsyncInit = function() {
      ...
      FB.getLoginStatus(function(response) {
        $(document).trigger('deals.loadPersonalInfo');
      });
      FB.Event.subscribe('auth.login', function(response) {
        $(document).trigger('reload.controlbar');
        if (dls.isHomePage) {
          $(document).trigger('reload.buybox');
        }
        if (dls.isArticlePage) {
          $(document).trigger('reload.comments');
        }
        if (dls.isGiftCardPage) {
          $(document).trigger('reload.giftcards');
        }
      });
  
   // this will fire when any of the like widgets are "liked" by the user
    FB.Event.subscribe('edge.create', function(href, widget) {
    //console.debug("you liked " + href);
  ...
  logout: function() {
    dls._logout();
    FB.logout(function(response) { window.location = "/deals"; });
    return false;
  }
};
...
var Gifting = {
  toggleForm: function(elem) {
    var wrapper = $(elem).closest('.gift-coupon');
    wrapper.toggleClass('collapsed');
    this.toggleCheckbox(wrapper.find('div.gift_checkbox').first());
  },

  toggleCheckbox: function(elem) {
    var checkbox = $(elem);
    var hidden_field = checkbox.children('input').first();
    if(hidden_field.val() == '') {
      hidden_field.val("true");
    } else {
      hidden_field.val("");
    }
    checkbox.closest('.gift_banner_content').toggleClass('checked');
  },
...
var ZeroClipboard = {
	...
	moviePath: '/deals/swf/ZeroClipboard.swf', // URL to movie
...
dls.fte_cities = {"United Kingdom":[{"id":241,"name":"Aberdeen","country":"United Kingdom"},{"id":242,"name":"Belfast","country":"United Kingdom"},{"id":63,"name":"Birmingham, UK","country":"United Kingdom"},{"id":244,"name":"Blackpool","country":"United Kingdom"},{"id":245,"name":"Bournemouth","country":"United Kingdom"},{"id":246,"name":"Bradford ","country":"United Kingdom"},{"id":210,"name":"Brighton","country":"United Kingdom"},{"id":212,"name":"Bristol","country":"United Kingdom"},{"id":247,"name":"Cambridge","country":"United Kingdom"},{"id":213,"name":"Cardiff","country":"United Kingdom"},{"id":270,"name":"Cheltenham","country":"United Kingdom"},{"id":990,"name":"Chester","country":"United Kingdom"},{"id":249,"name":"Derby","country":"United Kingdom"},{"id":508,"name":"East London","country":"United Kingdom"},{"id":214,"name":"Edinburgh","country":"United Kingdom"},{"id":69,"name":"Glasgow","country":"United Kingdom"},{"id":1591,"name":"Harrogate","country":"United Kingdom"},{"id":71,"name":"Leeds","country":"United Kingdom"},{"id":225,"name":"Leicester","country":"United Kingdom"},{"id":72,"name":"Liverpool","country":"United Kingdom"},{"id":1735,"name":"Liverpool - Citywide","country":"United Kingdom"},{"id":58,"name":"London","country":"United Kingdom"},{"id":1733,"name":"London - Citywide","country":"United Kingdom"},{"id":73,"name":"Manchester","country":"United Kingdom"},{"id":1569,"name":"National, UK","country":"United Kingdom"},{"id":215,"name":"Newcastle, UK","country":"United Kingdom"},{"id":1004,"name":"North Cheshire","country":"United Kingdom"},{"id":506,"name":"North London","country":"United Kingdom"},{"id":1003,"name":"North Manchester","country":"United Kingdom"},{"id":251,"name":"Norwich","country":"United Kingdom"},{"id":252,"name":"Nottingham","country":"United Kingdom"},{"id":240,"name":"Oxford","country":"United Kingdom"},{"id":253,"name":"Plymouth","country":"United Kingdom"},{"id":255,"name":"Portsmouth","country":"United Kingdom"},{"id":256,"name":"Reading","country":"United Kingdom"},{"id":222,"name":"Sheffield","country":"United Kingdom"},{"id":507,"name":"South East London","country":"United Kingdom"},{"id":1002,"name":"South Manchester","country":"United Kingdom"},{"id":885,"name":"South West London","country":"United Kingdom"},{"id":257,"name":"Southampton","country":"United Kingdom"},{"id":259,"name":"Stoke-on-Trent","country":"United Kingdom"},{"id":260,"name":"Sunderland","country":"United Kingdom"},{"id":297,"name":"Swansea","country":"United Kingdom"},{"id":248,"name":"Warwickshire","country":"United Kingdom"},{"id":509,"name":"West London","country":"United Kingdom"},{"id":1008,"name":"Wirral","country":"United Kingdom"},{"id":303,"name":"Wolverhampton / Black Country","country":"United Kingdom"},{"id":261,"name":"York, UK","country":"United Kingdom"}],"United Arab Emirates":[{"id":871,"name":"Abu Dhabi","country":"United Arab Emirates"},{"id":591,"name":"Dubai","country":"United Arab Emirates"},{"id":1459,"name":"Sharjah","country":"United Arab Emirates"}],"Australia":[{"id":906,"name":"Adelaide - Citywide","country":"Australia"},{"id":80,"name":"Adelaide - North","country":"Australia"},{"id":998,"name":"Adelaide - South","country":"Australia"},{"id":1055,"name":"Australia - Nationwide","country":"Australia"},{"id":905,"name":"Brisbane - Citywide","country":"Australia"},{"id":973,"name":"Brisbane Bayside","country":"Australia"},{"id":65,"name":"Brisbane Inner City","country":"Australia"},{"id":974,"name":"Brisbane North","country":"Australia"},{"id":975,"name":"Brisbane South","country":"Australia"},{"id":976,"name":"Brisbane West","country":"Australia"},{"id":384,"name":"Canberra","country":"Australia"},{"id":983,"name":"Canberra - Citywide","country":"Australia"},{"id":498,"name":"Darwin","country":"Australia"},{"id":494,"name":"Geelong","country":"Australia"},{"id":1661,"name":"Geelong - Citywide","country":"Australia"},{"id":381,"name":"Gold Coast","country":"Australia"},{"id":904,"name":"Gold Coast - Citywide","country":"Australia"},{"id":383,"name":"Hobart","country":"Australia"},{"id":74,"name":"Melbourne Inner City","country":"Australia"},{"id":903,"name":"Melbourne - Citywide","country":"Australia"},{"id":972,"name":"Melbourne - Mornington Peninsula","country":"Australia"},{"id":971,"name":"Melbourne East","country":"Australia"},{"id":988,"name":"Melbourne North","country":"Australia"},{"id":970,"name":"Melbourne South","country":"Australia"},{"id":989,"name":"Melbourne West","country":"Australia"},{"id":493,"name":"Newcastle","country":"Australia"},{"id":984,"name":"Newcastle - Citywide","country":"Australia"},{"id":907,"name":"Perth - Citywide","country":"Australia"},{"id":84,"name":"Perth - North","country":"Australia"},{"id":999,"name":"Perth - South","country":"Australia"},{"id":902,"name":"Sydney - Citywide","country":"Australia"},{"id":79,"name":"Sydney - Eastern Suburbs","country":"Australia"},{"id":847,"name":"Sydney - Greater West","country":"Australia"},{"id":848,"name":"Sydney - Inner West","country":"Australia"},{"id":849,"name":"Sydney - Northern Beaches","country":"Australia"},{"id":850,"name":"Sydney - Northern Suburbs","country":"Australia"},{"id":851,"name":"Sydney - Southern","country":"Australia"},{"id":385,"name":"Wollongong","country":"Australia"},{"id":1169,"name":"Wollongong - Citywide","country":"Australia"}],"United States":[{"id":90,"name":"Akron / Canton","country":"United States"},{"id":368,"name":"Albany / Capital Region","country":"United States"},{"id":35,"name":"Albuquerque","country":"United States"},{"id":94,"name":"Ann Arbor","country":"United States"},{"id":529,"name":"Annapolis","country":"United States"},{"id":1165,"name":"Arlington / Alexandria","country":"United States"},{"id":34,"name":"Atlanta","country":"United States"},{"id":840,"name":"Buckhead","country":"United States"},{"id":580,"name":"Cobb County","country":"United States"},{"id":1697,"name":"Metro Atlanta","country":"United States"},{"id":97,"name":"Augusta / Aiken","country":"United States"},{"id":18,"name":"Austin","country":"United States"},{"id":23,"name":"Baltimore","country":"United States"},{"id":856,"name":"Baltimore County","country":"United States"},{"id":100,"name":"Baton Rouge","country":"United States"},{"id":223,"name":"Bellevue / Eastside","country":"United States"},{"id":531,"name":"Bergen County","country":"United States"},{"id":342,"name":"Berkeley","country":"United States"},{"id":101,"name":"Billings","country":"United States"},{"id":64,"name":"Birmingham, AL","country":"United States"},{"id":349,"name":"Boca Raton / Lake Worth","country":"United States"},{"id":102,"name":"Boise","country":"United States"},{"id":2,"name":"Boston","country":"United States"},{"id":335,"name":"Boston - Metrowest","country":"United States"},{"id":336,"name":"Boston - South Shore","country":"United States"},{"id":176,"name":"Boston North","country":"United States"},{"id":209,"name":"Boulder County","country":"United States"},{"id":234,"name":"Brooklyn","country":"United States"},{"id":66,"name":"Buffalo","country":"United States"},{"id":106,"name":"Cedar Rapids / Iowa City","country":"United States"},{"id":107,"name":"Charleston, SC","country":"United States"},{"id":532,"name":"Charleston, WV","country":"United States"},{"id":21,"name":"Charlotte","country":"United States"},{"id":844,"name":"Charlotte North","country":"United States"},{"id":533,"name":"Charlottesville","country":"United States"},{"id":108,"name":"Chattanooga","country":"United States"},{"id":6,"name":"Chicago","country":"United States"},{"id":484,"name":"Chicago - South / Southwest Suburbs","country":"United States"},{"id":1705,"name":"Chicagoland","country":"United States"},{"id":326,"name":"Chicago - North Suburbs","country":"United States"},{"id":327,"name":"Chicago - Northwest Suburbs","country":"United States"},{"id":98,"name":"Chicago - Western Suburbs","country":"United States"},{"id":56,"name":"Cincinnati","country":"United States"},{"id":854,"name":"Cleveland Eastside","country":"United States"},{"id":41,"name":"Cleveland Westside","country":"United States"},{"id":48,"name":"Colorado Springs","country":"United States"},{"id":200,"name":"Columbia, SC","country":"United States"},{"id":19,"name":"Columbus","country":"United States"},{"id":348,"name":"Coral Gables / South Miami","country":"United States"},{"id":116,"name":"Corpus Christi","country":"United States"},{"id":11,"name":"Dallas","country":"United States"},{"id":117,"name":"Dayton","country":"United States"},{"id":26,"name":"Denver ","country":"United States"},{"id":857,"name":"Denver North","country":"United States"},{"id":858,"name":"Denver South","country":"United States"},{"id":118,"name":"Des Moines","country":"United States"},{"id":14,"name":"Detroit","country":"United States"},{"id":852,"name":"Detroit - Northeast Suburbs","country":"United States"},{"id":853,"name":"Detroit - Northwest Suburbs","country":"United States"},{"id":330,"name":"DFW Mid-Cities","country":"United States"},{"id":331,"name":"Durham / Chapel Hill","country":"United States"},{"id":39,"name":"East Valley, AZ","country":"United States"},{"id":24,"name":"El Paso","country":"United States"},{"id":123,"name":"Eugene","country":"United States"},{"id":127,"name":"Flint","country":"United States"},{"id":128,"name":"Fort Collins","country":"United States"},{"id":129,"name":"Ft. Lauderdale","country":"United States"},{"id":105,"name":"Fort Myers / Cape Coral","country":"United States"},{"id":130,"name":"Fort Wayne","country":"United States"},{"id":20,"name":"Fort Worth","country":"United States"},{"id":36,"name":"Fresno","country":"United States"},{"id":132,"name":"Gainesville","country":"United States"},{"id":1171,"name":"Georgetown / Foggy Bottom","country":"United States"},{"id":133,"name":"Grand Rapids","country":"United States"},{"id":134,"name":"Green Bay","country":"United States"},{"id":135,"name":"Greensboro / High Point","country":"United States"},{"id":208,"name":"Greenville","country":"United States"},{"id":162,"name":"Hampton Roads Peninsula","country":"United States"},{"id":518,"name":"Harrisburg / York, PA","country":"United States"},{"id":70,"name":"Hartford","country":"United States"},{"id":864,"name":"Henderson / Southeast Las Vegas","country":"United States"},{"id":305,"name":"Hoboken / Jersey City","country":"United States"},{"id":82,"name":"Honolulu","country":"United States"},{"id":7,"name":"Houston","country":"United States"},{"id":338,"name":"Sugar Land / West Houston","country":"United States"},{"id":855,"name":"Howard County, MD","country":"United States"},{"id":141,"name":"Huntsville","country":"United States"},{"id":17,"name":"Indianapolis","country":"United States"},{"id":861,"name":"Carmel / Fishers","country":"United States"},{"id":334,"name":"Inland Empire","country":"United States"},{"id":142,"name":"Jackson","country":"United States"},{"id":16,"name":"Jacksonville","country":"United States"},{"id":590,"name":"Jacksonville Beaches","country":"United States"},{"id":862,"name":"Johnson County, KS","country":"United States"},{"id":40,"name":"Kansas City","country":"United States"},{"id":144,"name":"Knoxville","country":"United States"},{"id":145,"name":"Lafayette","country":"United States"},{"id":146,"name":"Lancaster / Reading","country":"United States"},{"id":30,"name":"Las Vegas","country":"United States"},{"id":91,"name":"Lehigh Valley","country":"United States"},{"id":149,"name":"Lexington","country":"United States"},{"id":150,"name":"Lincoln","country":"United States"},{"id":151,"name":"Little Rock","country":"United States"},{"id":38,"name":"Long Beach","country":"United States"},{"id":4,"name":"Los Angeles","country":"United States"},{"id":32,"name":"Louisville","country":"United States"},{"id":153,"name":"Lubbock","country":"United States"},{"id":154,"name":"Madison","country":"United States"},{"id":343,"name":"Marin County","country":"United States"},{"id":22,"name":"Memphis","country":"United States"},{"id":517,"name":"Mercer / Middlesex Counties","country":"United States"},{"id":43,"name":"Miami","country":"United States"},{"id":886,"name":"North Miami-Dade / South Broward","country":"United States"},{"id":1903,"name":"Milwaukee - North / West ","country":"United States"},{"id":25,"name":"Milwaukee - South","country":"United States"},{"id":47,"name":"Minneapolis","country":"United States"},{"id":157,"name":"Mobile / Baldwin County","country":"United States"},{"id":366,"name":"Monterey Bay Area","country":"United States"},{"id":230,"name":"Montgomery County","country":"United States"},{"id":161,"name":"Morris / Somerset Counties","country":"United States"},{"id":520,"name":"Napa / Sonoma","country":"United States"},{"id":524,"name":"Naples","country":"United States"},{"id":28,"name":"Nashville","country":"United States"},{"id":863,"name":"Williamson County, TN","country":"United States"},{"id":587,"name":"Nassau County","country":"United States"},{"id":59,"name":"New Orleans","country":"United States"},{"id":329,"name":"North Dallas / Plano","country":"United States"},{"id":60,"name":"North Orange County","country":"United States"},{"id":839,"name":"North Orlando","country":"United States"},{"id":333,"name":"Northeast Atlanta","country":"United States"},{"id":842,"name":"Northern Kentucky","country":"United States"},{"id":582,"name":"Northern Vermont","country":"United States"},{"id":229,"name":"Northern Virginia","country":"United States"},{"id":126,"name":"Northwest Arkansas","country":"United States"},{"id":231,"name":"NYC Downtown","country":"United States"},{"id":3,"name":"NYC Midtown","country":"United States"},{"id":233,"name":"NYC - Upper East Side","country":"United States"},{"id":865,"name":"NYC - Upper West Side","country":"United States"},{"id":44,"name":"Oakland / East Bay","country":"United States"},{"id":1907,"name":"Ocean / Monmouth Counties","country":"United States"},{"id":33,"name":"Oklahoma City","country":"United States"},{"id":588,"name":"Olympia","country":"United States"},{"id":50,"name":"Omaha","country":"United States"},{"id":75,"name":"Orlando","country":"United States"},{"id":167,"name":"Palm Bay","country":"United States"},{"id":9,"name":"Philadelphia","country":"United States"},{"id":994,"name":"Philadelphia - Northern Suburbs","country":"United States"},{"id":340,"name":"Philadelphia - Western Suburbs","country":"United States"},{"id":8,"name":"Phoenix","country":"United States"},{"id":1723,"name":"Phoenix Citywide","country":"United States"},{"id":49,"name":"Pittsburgh","country":"United States"},{"id":843,"name":"Pittsburgh North","country":"United States"},{"id":31,"name":"Portland, OR","country":"United States"},{"id":1757,"name":"Greater Portland","country":"United States"},{"id":867,"name":"Portland Eastside / Vancouver, WA","country":"United States"},{"id":207,"name":"Portland, ME","country":"United States"},{"id":76,"name":"Providence","country":"United States"},{"id":549,"name":"Queens","country":"United States"},{"id":45,"name":"Raleigh","country":"United States"},{"id":172,"name":"Reno","country":"United States"},{"id":77,"name":"Richmond","country":"United States"},{"id":526,"name":"Roanoke","country":"United States"},{"id":201,"name":"Rochester","country":"United States"},{"id":868,"name":"Roseville / Folsom, CA","country":"United States"},{"id":581,"name":"Round Rock / Georgetown, TX","country":"United States"},{"id":37,"name":"Sacramento","country":"United States"},{"id":1759,"name":"Greater Sacramento","country":"United States"},{"id":78,"name":"Salt Lake City","country":"United States"},{"id":10,"name":"San Antonio","country":"United States"},{"id":12,"name":"San Diego","country":"United States"},{"id":122,"name":"San Diego - North County","country":"United States"},{"id":1847,"name":"San Diego East County","country":"United States"},{"id":15,"name":"San Francisco","country":"United States"},{"id":1727,"name":"San Francisco Bay Area","country":"United States"},{"id":120,"name":"San Gabriel Valley","country":"United States"},{"id":13,"name":"San Jose","country":"United States"},{"id":528,"name":"Santa Barbara","country":"United States"},{"id":536,"name":"Sarasota","country":"United States"},{"id":179,"name":"Savannah / Hilton Head","country":"United States"},{"id":341,"name":"Scottsdale","country":"United States"},{"id":206,"name":"Scranton / Wilkes-Barre","country":"United States"},{"id":27,"name":"Seattle","country":"United States"},{"id":361,"name":"Snohomish County","country":"United States"},{"id":491,"name":"SF Peninsula","country":"United States"},{"id":86,"name":"San Fernando Valley","country":"United States"},{"id":344,"name":"Walnut Creek / Contra Costa","country":"United States"},{"id":180,"name":"Shreveport","country":"United States"},{"id":182,"name":"South Bend","country":"United States"},{"id":42,"name":"South Hampton Roads","country":"United States"},{"id":346,"name":"South Jersey","country":"United States"},{"id":881,"name":"South Orange County","country":"United States"},{"id":841,"name":"South Orlando / Kissimmee","country":"United States"},{"id":87,"name":"Southern CT","country":"United States"},{"id":530,"name":"Southern New Hampshire","country":"United States"},{"id":183,"name":"Spokane / Coeur d'Alene","country":"United States"},{"id":202,"name":"Springfield","country":"United States"},{"id":859,"name":"St. Charles County","country":"United States"},{"id":51,"name":"St. Louis","country":"United States"},{"id":1765,"name":"St. Louis - Citywide","country":"United States"},{"id":860,"name":"St. Louis - West County","country":"United States"},{"id":226,"name":"St. Paul","country":"United States"},{"id":185,"name":"St. Pete / Clearwater","country":"United States"},{"id":186,"name":"Stockton / Modesto","country":"United States"},{"id":325,"name":"Suffolk County, NY","country":"United States"},{"id":187,"name":"Syracuse","country":"United States"},{"id":188,"name":"Tacoma","country":"United States"},{"id":189,"name":"Tallahassee","country":"United States"},{"id":52,"name":"Tampa","country":"United States"},{"id":586,"name":"The Woodlands / North Houston","country":"United States"},{"id":190,"name":"Toledo","country":"United States"},{"id":85,"name":"Tucson","country":"United States"},{"id":46,"name":"Tulsa","country":"United States"},{"id":1905,"name":"Union / Essex Counties","country":"United States"},{"id":170,"name":"Utah County","country":"United States"},{"id":166,"name":"Ventura County","country":"United States"},{"id":195,"name":"Waco / Killeen","country":"United States"},{"id":1,"name":"Washington, D.C.","country":"United States"},{"id":1709,"name":"Washington, D.C. Citywide","country":"United States"},{"id":205,"name":"West Palm Beach / Jupiter","country":"United States"},{"id":576,"name":"West Valley, AZ","country":"United States"},{"id":347,"name":"Westchester County","country":"United States"},{"id":192,"name":"Westside / SouthBay","country":"United States"},{"id":196,"name":"Wichita","country":"United States"},{"id":198,"name":"Wilmington / Newark","country":"United States"},{"id":199,"name":"Winston - Salem","country":"United States"},{"id":88,"name":"Worcester","country":"United States"}],"Jordan":[{"id":1439,"name":"Amman","country":"Jordan"}],"Netherlands":[{"id":61,"name":"Amsterdam","country":"Netherlands"},{"id":306,"name":"Den Haag","country":"Netherlands"},{"id":764,"name":"Eindhoven","country":"Netherlands"},{"id":768,"name":"Haarlem","country":"Netherlands"},{"id":307,"name":"Rotterdam","country":"Netherlands"},{"id":777,"name":"Tilburg","country":"Netherlands"},{"id":778,"name":"Utrecht","country":"Netherlands"}],"New Zealand":[{"id":62,"name":"Auckland","country":"New Zealand"},{"id":987,"name":"Auckland - Citywide","country":"New Zealand"},{"id":512,"name":"Wellington","country":"New Zealand"}],"Lebanon":[{"id":1433,"name":"Beirut","country":"Lebanon"}],"France":[{"id":442,"name":"Bordeaux","country":"France"},{"id":450,"name":"Lille","country":"France"},{"id":315,"name":"Lyon","country":"France"},{"id":314,"name":"Marseille","country":"France"},{"id":447,"name":"Montpellier","country":"France"},{"id":1559,"name":"Neuilly Boulogne Levallois","country":"France"},{"id":445,"name":"Nice - Cannes","country":"France"},{"id":1685,"name":"Paris Est /  du 10eme au 13eme -  du 18eme au 20eme","country":"France"},{"id":1679,"name":"Paris Ouest / 8eme - 16eme - 17eme","country":"France"},{"id":313,"name":"Paris Rive Droite / 1er - 2\u00e8me - 3eme - 4eme - 9\u00e8me","country":"France"},{"id":1683,"name":"Paris Rive Gauche / 5eme - 6eme - 7eme - 14eme - 15eme","country":"France"},{"id":428,"name":"Strasbourg","country":"France"},{"id":1561,"name":"Versailles Saint-Germain-en-Laye","country":"France"}],"Canada":[{"id":218,"name":"Brampton","country":"Canada"},{"id":67,"name":"Calgary","country":"Canada"},{"id":372,"name":"Durham Region","country":"Canada"},{"id":81,"name":"Edmonton","country":"Canada"},{"id":217,"name":"Hamilton","country":"Canada"},{"id":377,"name":"Kitchener / Waterloo","country":"Canada"},{"id":371,"name":"London, ON","country":"Canada"},{"id":216,"name":"Mississauga","country":"Canada"},{"id":54,"name":"Montreal","country":"Canada"},{"id":83,"name":"Ottawa","country":"Canada"},{"id":53,"name":"Toronto","country":"Canada"},{"id":57,"name":"Vancouver","country":"Canada"},{"id":375,"name":"Victoria","country":"Canada"},{"id":219,"name":"Winnipeg","country":"Canada"},{"id":345,"name":"York Region","country":"Canada"}],"Egypt":[{"id":592,"name":"Cairo","country":"Egypt"}],"Ireland":[{"id":513,"name":"Cork","country":"Ireland"},{"id":1739,"name":"Dublin - Citywide","country":"Ireland"},{"id":515,"name":"Galway","country":"Ireland"},{"id":514,"name":"Limerick","country":"Ireland"},{"id":1482,"name":"North Dublin","country":"Ireland"},{"id":68,"name":"South Dublin","country":"Ireland"}]};
/*
    ...
    return this.each(function() {
      ...
      function rebuildList(available_times) {
        ...
        if (available_times == undefined) {
          ...
          var time;
          var previous_time;
          var num_available_times = available_times.length - 1;
      ...
      function day_li(time_slot, has_options){
        ...
        var li = '<li id="option_' + time_slot.id + '" class="' + (has_options ? "with-options " : "") + '' + ((time_slot.sold_out) ? 'sold-out ' : 'available ') +'"><span class="time">' + time_slot.start_time + '</span> <span class="spots-left">' + message +"</span>";
        if(has_options) {
      ...
      $(".datepicker", $this).datepicker({
        ...
        onChangeMonthYear: function(year, month, inst) {
          var month = dateToString(year,month-1);
          if (months_with_events[month] ) {
            for(var day in dates_allowed) {
              if(day.indexOf(month) != -1){
                $('.datepicker', $this).datepicker("setDate", new Date(day.replace(/-/g, "/")) );
                rebuildList(dates_allowed[day]);
                break;
              }
            }
          } else {
...
(function($) {
  ...
  $.extend(QuickCheckout.prototype, {
    markerClassName: 'hasQuickCheckout',
    processing: false,
    form: null,
    dealInfoSelector: '.deal-info',
    giftSelector: '.send-as-a-gift',
    dealPriceSelector: '#deal-buy-box .deal-price.deal-price-lg',
    buyBoxSelector: '#deal-buy-box .deal-buy-box .button',
    termsLinks: '.qc-container .terms a',
    proceedLink: '.qc-container .proceed a',
    purchaseButton: '.qc-container .button.buy-now',
    ...
    _attachQuickCheckout: function(target, settings) {
      target = $(target);
      if (target.hasClass(this.markerClassName)) {
      ...
      this._createPurchaseForm(target, settings);
      this._buttonBuyClickHandler(target);
      this._toggleQuickCheckout(target, settings);
      this._openLinksInNewWindow();
    },
    _createPurchaseForm: function(element, settings) {
      var instance = $.data(element[0], PROP_NAME);
      $.extend(instance.settings, settings);
      this.form = $('<form id="https-purchase-form" method="POST" action="'+ instance.settings.purchaseUrl +'" />').html(
        '<input name="purchase[order_quantities][' + instance.settings.optionId + ']" type="hidden" value="1" />' +
        '<input name="credit_card_id" type="hidden" value="' + instance.settings.creditCardId + '" />' +
        '<input name="quick_checkout" type="hidden" value="1" />');
      $('body').append(this.form); //stick the form somewhere that can always be selected
    },
    _buttonBuyClickHandler: function(element, settings) {
      var self = this;
      var instance = $.data(element[0], PROP_NAME);
      $.extend(instance.settings, settings);
      $(self.buyBoxSelector).bind('click', function(e) {
        e.preventDefault();
        e.stopPropagation();

        var qc = $('.qc-container');
        if (!(qc.is(':visible'))) {
          element.trigger('qc:toggle');
        }
      });
    },
    _buttonPurchaseClickHandler: function(element, settings) {
      var instance = $.data(element[0], PROP_NAME);
      $.extend(instance.settings, settings);
      var self = this;
      $(self.purchaseButton).bind('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        if (self.processing) {
          return;
        } else {
          self._purchaseDeal(element, settings);
        }
      });
    },
    _toggleQuickCheckout: function(element, settings) {
      var self = this;
      var instance = $.data(element[0], PROP_NAME);
      $.extend(instance.settings, settings);
      $(element).bind('qc:toggle', function(e) {
        var qc = $('.qc-container');
        if (qc.is(':visible')) {
          qc.fadeOut(200); // TODO improve reverse animation

          $('html').unbind('click');
          $(this).html('<span>' + instance.settings.buyButtonLabel + '</span>');

          $(self.giftSelector).show();
          $(self.dealPriceSelector).show();
          $(self.buyBoxSelector).show();
          $(self.dealInfoSelector).animate({marginTop: '0px'}, 200);

        } else {
          $(self.giftSelector).hide();
          $(self.dealPriceSelector).hide();
          $(self.buyBoxSelector).hide();

          $(self.dealInfoSelector).animate({marginTop: '50px'}, 250, function() {
            $(this).css({marginTop: '7px'});
            qc.fadeIn(200);
          });

          $('.button.buy-now', '.qc-container').html('<span>'+ instance.settings.purchaseButtonLabel +'</span>');

          $('html').bind('click', function(e) {
            if (!($(e.target).is(self.termsLinks)) && !($(e.target).is(self.purchaseButton)) && !($(e.target).is(self.proceedLink))) {
              e.preventDefault();
              element.trigger('qc:toggle');
            }
          });
          self._buttonPurchaseClickHandler(element, settings);
        }
      });
    },
    _purchaseDeal: function(element, settings) {
      var instance = $.data(element[0], PROP_NAME);
      $.extend(instance.settings, settings);
      $(this.purchaseButton).addClass('processing');
      $(this.purchaseButton).html(instance.settings.processingLabel);
      $('html').unbind('click');
      if (!this.processing) {
    ...
    _openLinksInNewWindow: function() {
      $(this.termsLinks).attr('target', '_blank');
    }
  });

  $.fn.quickCheckout = function(options) {
    return this.each(function() {
      if (typeof options == 'string') {
        $.quickCheckout['_' + options + 'QuickCheckout'].
          apply($.quickCheckout, [this].concat(otherArgs));
      }
      else {
        $.quickCheckout._attachQuickCheckout(this, options || {});
      }
    });
  };
