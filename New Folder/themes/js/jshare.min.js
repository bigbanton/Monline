...
$('#jshare_share_link').click(function() {
									   ...
									   $('#jshare_email').fadeOut(function(){
															...
															$('#jshare_email').css('display','none');$('#jshare_bookmark').css('display','none');
...
$('#jshare_bookmark_link').click(function() {
									   ...
									   $('#jshare_email').fadeOut(function() {
																			...
																			$('#jshare_email').css('display','none');$('#jshare_share').css('display','none');
...
$('#jshare_email_link').click(function() {
									   ...
									   if(settings.emailform){
										   ...
										   $('#jshare_bookmark').fadeOut(function() {
																					...
																					$('#jshare_bookmark').css('display','none');$('#jshare_share').css('display','none');
