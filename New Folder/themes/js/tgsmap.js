var ClonePortalMap = function (g) {
        ...
        this.initialize = function (a) {
            ...
            if (!this.container) {
                ...
                document.write("Could not locate \"" + this.options.container + "\"");
        ...
        this.getIcon = function () {
            ...
            a.image = BASE_REF + "/themes/css/default/icon.png";

            a.shadow = BASE_REF + "/themes/css/default/shadow.png";
        ...
        this.handleGetLocatorResponse = function (a) {
            ...
            if (!a) {
                ...
                document.write("Could not resolve the address on Google Map: \"" + this.options.address + "\"");
