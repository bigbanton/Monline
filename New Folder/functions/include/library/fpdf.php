...
/**
    ...
    
    {
         ...
         if (!defined('FPDF_FONTPATH') && is_dir(dirname(dirname(dirname(dirname(__FILE__)))) . '/themes/css/font'))
            
             define('FPDF_FONTPATH', dirname(dirname(dirname(dirname(__FILE__)))) . '/themes/css/font/');
