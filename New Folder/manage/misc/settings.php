...
if ($quer == 'remav') {
    ...
    Utility::Redirect(BASE_REF . '/manage/misc/settings.php ');
...
if ($_POST) {
    ...
    $table->avatar = upload_image_user('upload_image', $login_user['avatar'], 'user', $login_user_id);
     ...
     if ($table->update($update)) {
        ...
        // ACTIVITY LOG
        ZLog::Log($login_user_id, 'System Settings', 'System settings updated');
        ...
        // ACTIVITY LOG
        ZLog::Log($login_user_id, 'System Settings', 'Alert >> System settings save failed', 1);
...
include template('manage_admin_settings');
